...
(1, 'Banner trang chủ 1', '14-gridleftsub2.jpg', '', 0);
...
(57, '2018-06-05', '30', 2000000, 1),
(58, '2018-06-05', '61', 1079000, 1),
(59, '2018-06-23', '61', 400000, 1),
(62, '2018-06-23', '61', 305000, 1),
(61, '2018-06-23', '61', 400000, 1),
(63, '2018-06-23', '31', 310000, 2),
(64, '2018-07-08', '62', 305000, 1),
(65, '2018-07-08', '61', 1000000, 2),
(66, '2018-07-08', '61', 400000, 1),
(67, '2018-07-08', '64', 2468000, 1),
(68, '2018-07-08', '59', 1000000, 1),
(69, '2018-07-16', '64', 705000, 1),
(70, '2018-07-17', '61', 610000, 1),
(71, '2018-07-17', '61', 2158000, 1);
...
INSERT INTO `loai_bai_viet` (`ma_loai_bai_viet`, `ten_loai_bai_viet`, `mo_ta`) VALUES
(194, 'Tin khuyến mãi', 'Mô tả về tin tức khuyên mại'),
(195, 'Tin công nghệ', 'Mô tả về tin tức công nghệ'),
(196, 'Sản phẩm mới', 'cung cấp thông tin mới nhất về abc');
...
(61, 2, 'Tuấn anh', 0, 'asdasd', 'e10adc3949ba59abbe56e057f20f883e', 'tuanseoeakar@gmail.com', '016988337361', 'Tân Biên - Tây Ninh 1', '2017-03-24', NULL, 1),
...
(62, 2, 'Tiêu phương', 0, 'tieuphuong', 'e10adc3949ba59abbe56e057f20f883e', 'tieuphuong@gmail.com', '01628656956', 'd3 , tổ 4 , khu phố 1 , phường Tăng nhơn phú A , Quận 9 , Tp hồ chí minh', '2018-06-23', NULL, 1),
(63, 2, 'Tuấn anh123', 0, 'tieuphuong123', 'e10adc3949ba59abbe56e057f20f883e', 'tuanseoeakar@gmail.com', '01628656956', 'd3 , tổ 4 , khu phố 1 , phường Tăng nhơn phú A , Quận 9 , Tp hồ chí minh', '2018-06-23', NULL, 0),
(64, 2, 'Tiêu phương 123', 0, 'tieuphuong333', 'e10adc3949ba59abbe56e057f20f883e', 'tuanseoeakar@gmail.com', '01628656956', 'd3 , tổ 4 , khu phố 1 , phường Tăng nhơn phú A , Quận 9 , Tp hồ chí minh', '2018-06-23', NULL, 1),
(70, 2, 'Tuấn đep trai', 0, 'sdsa', '4297f44b13955235245b2497399d7a93', 'tuanseoeakar@gmail.com', '123213213', 'd3 , tổ 4 , khu phố 1 , phường Tăng nhơn phú A , Quận 9 , Tp hồ chí minh', '2018-07-17', NULL, 1);
...
--
ALTER TABLE `bai_viet`
  MODIFY `ma_bai_viet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `hoa_don`
  MODIFY `so_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `loai_bai_viet`
--
ALTER TABLE `loai_bai_viet`
  MODIFY `ma_loai_bai_viet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;

--
-- AUTO_INCREMENT for table `loai_nguoi_dung`
--
ALTER TABLE `loai_nguoi_dung`
  MODIFY `ma_loai_nguoi_dung` tinyint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `loai_san_pham`
--
ALTER TABLE `loai_san_pham`
  MODIFY `ma_loai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;

--
-- AUTO_INCREMENT for table `nguoi_dung`
--
ALTER TABLE `nguoi_dung`
  MODIFY `ma_nguoi_dung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT for table `san_pham`
--
ALTER TABLE `san_pham`
  MODIFY `ma_san_pham` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=240;
COMMIT;
