		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-sm-6 col-xs-12">
					<div class="logo">
						<a href="index.html"><img src="layout/img/logo.png" alt="" /></a>
					</div>
				</div>
								...
								<li><a href="shop.html">shop</a>
									<div class="mega-menu">
										...
										<span class="mega-menu-photo">
											<a href="#"><img src="layout/img/megamenu/1.jpg" alt="" /></a>
										</span>
									</div>
								</li>
								...
								<div class="total-cart-brief">
									<div class="cart-photo-details">
										<div class="cart-photo">
											<a href="#"><img src="layout/img/total-cart/1.jpg" alt="" /></a>
										</div>
...
<section class="page-content">
	...
	<div class="slider-area margin-bottom-80">
		<div class="bend niceties preview-2">
			<div id="ensign-nivoslider" class="slides">
				<img src="layout/img/slider/slider-1/1.jpg" alt="" title="#slider-direction-1"  />
				<img src="layout/img/slider/slider-1/2.jpg" alt="" title="#slider-direction-2"  />
				<img src="layout/img/slider/slider-1/3.jpg" alt="" title="#slider-direction-3"  />
			</div>
			<!-- direction 1 -->
					...
					<div class="title-container s-tb-c title-compress">
						<div class="slider-1">
							...
							<div class="image wow fadeInUpBig" data-wow-duration="1.5s" data-wow-delay="0.7s">
								<span><img src="layout/img/slider/slider-1/slider-border.png" alt="" /></span>
							</div>
				...
				<div class="col-sm-12">
					<div class="single-banner fix">
						<div class="banner-photo padding-0 pull-left col-md-6 col-sm-6 col-xs-12">
							<a href="#"><img src="layout/img/banner/1.jpg" alt="" /></a>
						</div>
					...
					<div class="single-banner fix">
						...
						<div class="banner-photo padding-0 pull-right col-md-6 col-sm-6 col-xs-12">
							<a href="#"><img src="layout/img/banner/2.jpg" alt="" /></a>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="new-collection-area fix margin-bottom-80">
		...
		<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
			<div class="single-collection">
				<div class="collection-photo">
					<a href="#"><img src="layout/img/new-collection/1.jpg" alt="" /></a>
				</div>
		...
		<div class="col-lg-4 col-md-6 col-sm-6 padding-0">
			<div class="single-collection">
				<div class="collection-photo">
					<a href="#"><img src="layout/img/new-collection/2.jpg" alt="" /></a>
				</div>
				<div class="collection-brief">
					<div class="text-right">
						<span class="new">new</span>
		...
		<div class="col-lg-4 hidden-md hidden-sm padding-0 ">
			<div class="single-collection">
				<div class="collection-photo">
					<a href="#"><img src="layout/img/new-collection/3.jpg" alt="" /></a>
				</div>
				<div class="collection-brief">
					<div class="text-right">
						<span class="new">new</span>
		...
		<div id="active-product" class="product-slider">
			...
			<div class="single-product">
				<div class="product-photo">
					<a href="#">
						<img class="primary-photo" src="layout/img/product/1.jpg" alt="" />
						<img class="secondary-photo" src="layout/img/product/5.jpg" alt="" />
					</a>
			...
			<div class="single-product">
				<div class="product-photo">
					<a href="#">
						<img class="primary-photo" src="layout/img/product/2.jpg" alt="" />
						<img class="secondary-photo" src="layout/img/product/4.jpg" alt="" />
					</a>
					<div class="pro-action">
						<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
						<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
			...
			<div class="single-product">
				<div class="product-photo">
					<a href="#">
						<img class="primary-photo" src="layout/img/product/3.jpg" alt="" />
						<img class="secondary-photo" src="layout/img/product/1.jpg" alt="" />
					</a>
					<div class="pro-action">
						<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
						<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
			...
			<div class="single-product">
				<div class="product-photo">
					<a href="#">
						<img class="primary-photo" src="layout/img/product/4.jpg" alt="" />
						<img class="secondary-photo" src="layout/img/product/2.jpg" alt="" />
					</a>
					<div class="pro-action">
						<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
						<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
			...
			<div class="single-product">
				<div class="product-photo">
					<a href="#">
						<img class="primary-photo" src="layout/img/product/5.jpg" alt="" />
						<img class="secondary-photo" src="layout/img/product/3.jpg" alt="" />
					</a>
					<div class="pro-action">
						<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
						<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
		...
		<div class="promotional-banner">
			...
			<div class="col-md-6 col-sm-12 padding-0">
				<div class="single-promo-banner promo-banner-1">
					<!-- <img src="layout/img/banner/promo-banner/1.jpg" alt="" /> -->
			...
			<div class="col-md-6 col-sm-12 padding-0">
				<div class="single-promo-banner promo-banner-2">
					<!-- <img src="layout/img/banner/promo-banner/2.jpg" alt="" /> -->
					<div class="promo-banner-brief">
							...
							<div class="row">
								<div class="col-md-4 col-sm-4 col-xs-12">
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/1.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/6.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/4.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/1.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/2.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/4.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/5.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/1.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
								...
								<div class="col-md-4 col-sm-4 col-xs-12">
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/3.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/5.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
									...
									<div class="single-product">
										<div class="product-photo">
											<a href="#">
												<img class="primary-photo" src="layout/img/best-sell/6.jpg" alt="" />
												<img class="secondary-photo" src="layout/img/best-sell/2.jpg" alt="" />
											</a>
											<div class="pro-action">
												<a href="#" class="action-btn"><i class="sp-heart"></i><span>Wishlist</span></a>
												<a href="#" class="action-btn"><i class="sp-shopping-cart"></i><span>Add to cart</span></a>
		...
		<div class="container">
			<div class="row cus-row-1">
				<div class="single-featured single-featured-1 featured-link">
					<a href="#"><img src="layout/img/featured/1.jpg" alt="" /></a>
				...
				<div class="single-featured single-featured-2">
					<div class="single-featured-inner featured-link">
						<a href="#"><img src="layout/img/featured/2.jpg" alt="" /></a>
						<div class="featured-brief">
							<a href="#"><i class="sp-arrow-long-right"></i></a>
						</div>
					</div>
					<div class="single-featured-inner featured-link">
						<a href="#"><img src="layout/img/featured/3.jpg" alt="" /></a>
						<div class="featured-brief">
							<a href="#"><i class="sp-arrow-long-right"></i></a>
						</div>
					</div>
				...
				<div class="single-featured single-featured-1 featured-link">
					<a href="#"><img src="layout/img/featured/4.jpg" alt="" /></a>
					<div class="featured-brief">
						<a href="#"><i class="sp-arrow-long-right"></i></a>
					</div>
				</div>
				...
				<div class="col-md-7 col-sm-12">
					<div class="brand-logo fix">
						<div class="single-logo">
							<img src="layout/img/brand/1.png" alt="" />
						</div>
						<div class="single-logo">
							<img src="layout/img/brand/2.png" alt="" />
						</div>
						<div class="single-logo">
							<img src="layout/img/brand/3.png" alt="" />
						</div>
						<div class="single-logo">
							<img src="layout/img/brand/4.png" alt="" />
						</div>
						<div class="single-logo">
							<img src="layout/img/brand/5.png" alt="" />
						</div>
						<div class="single-logo">
							<img src="layout/img/brand/6.png" alt="" />
						</div>
					</div>
				</div>
			</div>
								...
								<div class="single-testimonial">
									<div class="col-md-4 col-sm-4 col-xs-12">
										<div class="client-photo">
											<img src="layout/img/testimonial/1.png" alt="" />
										</div>
									</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-blog">
						<div class="blog-photo">
							<a href="#"><img src="layout/img/blog/1.jpg" alt="" /></a>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-blog">
						<div class="blog-photo">
							<a href="#"><img src="layout/img/blog/2.jpg" alt="" /></a>
							<div class="blog-post-date">
								<span>13th</span>
								<span>Feb</span>
							</div>
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="single-blog">
						<div class="blog-photo">
							<a href="#"><img src="layout/img/blog/3.jpg" alt="" /></a>
							<div class="blog-post-date">
								<span>25th</span>
								<span>Feb</span>
							</div>
