  ...
  <div class="tab-content default-tab" id="tab1">
        <fieldset>
          ...
          <p>
            ...
            <label>Số hóa đơn: <?php echo $hoa_don->so_hoa_don ?></label> 
            <label><span style="margin-left:50px">Ngày lập hóa đơn: <?php echo date("d/m/Y",strtotime($hoa_don->ngay_hd)) ?></span></label>
          </p>
          <p> 
            <label>Trị giá: <?php echo number_format($hoa_don->tri_gia) ?> đồng</label>
          </p>
          <p>
            <label>Họ tên khách hàng: <?php echo $hoa_don->ho_ten ?></label>
          </p>  
          <p>
    ...
    <label><strong>Chi tiết hóa đơn</strong></label>
      ...
      <tfoot>
          <tr>
            ...
            <td colspan="3">
            <div class="pagination"><h4>Tổng thành tiền: <?php echo number_format($hoa_don->tri_gia) ?> đồng</h4> </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="vertical-align:middle"><img src="../images/<?php echo $ct->hinh; ?>" width="90px" height="70px" /></td>
