    ...
    <input class="button" type="submit" value="Tìm " name="btnTim" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="../tintuc/suatintuc.php?ma_tin_tuc=<?php echo $tin->ma_tin_tuc; ?>" title="Edit"><?php echo $tin->tieu_de ?></a></td>
          <td><?php echo $tin->tac_gia ?></td>
          <td><?php echo $tin->ngay_dang ?></td>
          <td><!-- Icons --> 
            <a href="../tintuc/suatintuc.php?ma_tin_tuc=<?php echo $tin->ma_tin_tuc ?>" title="Edit" >
            <img src="../tintuc/public/layout/resources/images/icons/pencil.png" alt="Edit" />
            </a> 
            <a href="javaScript:void(0)" title="Delete" onclick="Xoadulieu(<?php echo $tin->ma_tin_tuc ?>,'tin_tuc','ma_tin_tuc')"> 
            <img src="../tintuc/public/layout/resources/images/icons/cross.png" alt="Delete" />
            </a>
            </td>
        </tr>
        <?php 
