...
<title>Quản lý Shop Jean | Đăng nhập</title>
...
<body id="login">
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
                <h1>Quản lý Shop Jean</h1>
				<!-- Logo (221px width) -->
				<img id="logo" width="300" height="150" src="https://cdn2.f-cdn.com/contestentries/37489/6986542/5231b1227f6c0_thumb900.jpg" alt="Nhà Hàng Admin logo" />
			</div> <!-- End #logn-top -->
