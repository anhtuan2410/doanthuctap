  ...
  <div class="promotional-banner"> 
    ...
    <div class="col-md-6 col-sm-12 padding-0">
      <div class="single-promo-banner promo-banner-1"> 
        <!-- <img src="public/layout/img/banner/promo-banner/1.jpg" alt="" /> -->
        <div class="promo-banner-brief">
          <h2>sale !</h2>
          <h3>up to <span>30%</span> off</h3>
          <h4>mens best products</h4>
          <a class="shop-now active-shop-now" href="#">shop now</a> </div>
      </div>
    </div>
    <!-- Single-promo End --> 
    <!-- Single-promo start -->
    <div class="col-md-6 col-sm-12 padding-0">
      <div class="single-promo-banner promo-banner-2"> 
        <!-- <img src="public/layout/img/banner/promo-banner/2.jpg" alt="" /> -->
        <div class="promo-banner-brief">
          ...
          <div class="upcomming-brief">
            ...
            <a class="shop-now" href="#">pre order</a> </div>
        </div>
      </div>
    </div>
    <!-- Single-promo End --> 
