            ...
            <ul>
              <li><a href="#">Tài khoản <span><i class="sp-gear"></i></span></a>
                <ul class="submenu">
                  ...
                  {if isset($smarty.session.ten_dang_nhap)}
                  	Profiles
                  {else if}
                  	Đăng nhập
                  {/if}  
      ...
      <div class="row">
        ...
        <div class="col-md-2 col-sm-6 col-xs-12">
          <div class="total-cart">
            <ul>
              <li> <a href="gio_hang.php"> <span class="total-cart-number" id="SoLuong">{if isset ($smarty.session.gioHang)}{$smarty.session.gioHang|@count} Item{/if}</span> <span><i class="sp-shopping-bag"></i></span> </a> 
